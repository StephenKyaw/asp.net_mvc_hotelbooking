    ...
    public class HotelsController : Controller
    {
        ...
        private HotelViewModel BindHotelViewModel(Hotel hotel)
        {
            return new HotelViewModel()
            {
                ...
                HotelPhotos = hotel.HotelPhotos.Select(x => new HotelPhotoViewModel { FileName = x.FileName, ContentType = x.ContentType, HotelId = x.HotelId, OriginalFileName = x.OriginalFileName })
